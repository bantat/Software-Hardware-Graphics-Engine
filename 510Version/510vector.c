...
/* Assumes that there are dim + 2 arguments, the last dim of which are GLGLdoubles.
...
void vec3Spherical(GLdouble rho, GLdouble phi, GLdouble theta, GLdouble v[3]) {  // phi  = pi/2 , theta = pi
